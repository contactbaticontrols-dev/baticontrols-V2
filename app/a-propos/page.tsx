    ...
    <>
      <section className="bg-[#0A1120] pt-36 pb-20 relative overflow-hidden grid-bg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white mt-2 mb-4">À propos de BâtiControls</h1>
          <p className="text-[#94A3B8] text-lg max-w-2xl">Électricien installateur & prestataire spécialisé GTB depuis plusieurs années.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl font-black text-white mt-2 mb-6">Spécialistes GTB au service de vos bâtiments</h2>
              <div className="space-y-4 text-[#94A3B8] leading-relaxed">
                <p>BâtiControls est une société de prestation de services spécialisée dans la <strong className="text-white">Gestion Technique du Bâtiment (GTB)</strong>. Nous intervenons en tant qu'électricien installateur, prestataire et sous-traitant.</p>
                <p>Notre équipe de <strong className="text-white">8 experts techniques</strong> maîtrise l'ensemble des protocoles GTB du marché : KNX, BACnet, Modbus, Zigbee, LoRa, LOXONE, Node-RED et WATTSENS.</p>
                <p>Du câblage à la mise en service, nous assurons une prestation complète sur toute la France.</p>
              </div>
            </div>
            <div className="flex justify-center">
              <div className="relative">
                <div className="w-72 h-72 rounded-2xl overflow-hidden border border-[#334155]">
                  <Image src="/logo.jpg" alt="BâtiControls" width={288} height={288} className="w-full h-full object-cover" />
                </div>
                <div className="absolute -top-4 -left-4 bg-[#00897B] text-white rounded-xl p-4 glow-emerald-sm">
                  <p className="text-3xl font-black">8</p>
                  <p className="text-xs font-medium">Experts GTB</p>
                </div>
                <div className="absolute -bottom-4 -right-4 bg-[#1E293B] border border-[#334155] text-white rounded-xl p-4">
                  <p className="text-3xl font-black">7+</p>
                  <p className="text-xs font-medium text-[#94A3B8]">Protocoles</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#0A1120]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl font-black text-white mt-2">Ce qui nous distingue</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {valeurs.map((v) => (
              <div key={v.title} className="bg-[#1E293B] border border-[#334155] hover:border-[#00897B] rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:shadow-[#00897B]/10">
      ...
      <section className="py-20 bg-[#0F172A] relative overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-96 h-96 bg-[#00897B]/5 rounded-full blur-3xl" />
        </div>
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <Link href="/contact" className="bg-[#00897B] hover:bg-[#00695C] text-white font-bold px-8 py-4 rounded-xl transition-all glow-emerald-sm cursor-pointer">
            Nous contacter
          </Link>
        </div>
      </section>
